...
static const Rule rules[] = {
	...
	{ NULL,				NULL,      "Open File",0,         1,          1,           -1 },
	{ NULL,				NULL,      "Save File",0,         1,          1,           -1 },
};
...
static Key keys[] = {
    ...
    { MODKEY|Mod1Mask,              XK_l,      switchtag,      { .ui = SWITCHTAG_RIGHT  | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
    { MODKEY|Mod1Mask,              XK_h,      switchtag,      { .ui = SWITCHTAG_LEFT   | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
};
