...
static const char *fonts[]          = { "FuraCode Nerd Font:style=Regular:pixelsize=12:antialias=true:autohint=false", "Font Awesome Free:pixelsize=12" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_j,      movestack,      {.i = +2 } },
	{ MODKEY|ShiftMask,             XK_k,      movestack,      {.i = -2 } },
